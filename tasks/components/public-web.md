...
Independent QA PASS exact 6b899f9a582244d0df05b596778db79e50ca38ba: same 260px image-drag assertion fails at c3958c3 (scrollLeft stays zero) and passes candidate. Seven production-browser cases pass: two existing public/image scenarios plus five drag, click, arrow, release-outside, native touch/vertical scroll, cancel and keyboard cases. Retained the exact five-case QA regression as apps/web/tests/carousel-drag.spec.ts. PO authorized publication after this independent pass; no backend changes.
