...
## Latest acceptance and context update — 2026-09-23

This section supersedes the historical open findings above for the specified candidates only.

- Public preview `e65d8177e1d63c28eb2b148ccc721f460ec03f06`: independent QA and design pass for frontend-only visual preview. Publishing `team/public-web` is authorized; verify remote hash before notifying deployment readiness. No live backend, search/checkout/payment or full-site sign-off.
- Admin `07309ccb9e665522c6c24b18c5d89ad753a14547` (implementation `61b0913`): QA-01/02/03 and D01/D02 independently resolved. Latest QA14 browser cases cover recovery/isolation/storage/races; earlier session and signout cases pass. Design D01/D02 source/screenshot acceptance is bounded; full onboarding usability/P2 remains pending. Integration/PR updates still required.
- Bookings `e0ab96efafdfdedf77504f3fad7aa5e4264a0a99`: independent89 tests/221 assertions pass for synthetic nightly price and eligibility preconditions. `0521ccb` alone was rejected because checks were removed; correction restores mandatory per-night stock/restriction conditions. No real catalog binding or concurrency claim.
- Catalog `69766d1`: independent PostgreSQL17.11 StageA1 suite passed22 tests/171 assertions plus ten guard-negative cases. No schema/harness blocker; inventory/hold concurrency remains unimplemented. Catalog owns test cluster shutdown.
- User requested Graft context integration. Coordinator and eight worktrees have separate ignored local structural graphs. Shared curated relationships and operating instructions are in `docs/context/`; helper `scripts/graft-context.sh` builds only first-party source. No global hooks/MCP, provider-backed deep pass, Brain attachment, live data, runtime dependency or home-directory indexing.
